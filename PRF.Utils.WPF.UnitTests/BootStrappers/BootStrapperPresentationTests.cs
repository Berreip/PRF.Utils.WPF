...
namespace PRF.Utils.WPF.UnitTests.BootStrappers
{
    [TestFixture]
    ...
    internal sealed class BootStrapperPresentationTests
    {
        ...
        private sealed class BootForUnitTests : BootStrapperPresentation<ViewUnitTest, ViewModelUnitTest>
        {
        ...
        private class ViewModelUnitTest : NotifierBase
        {
        }
